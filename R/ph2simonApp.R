    ...
    ui = shiny::fluidPage(
      ...
      shiny::sidebarLayout(
        shiny::sidebarPanel(
          ...
          shiny::numericInput("num1", label ="Unacepptable rate", value = 0.1, min = 0, max = 1, step = 0.05),

          shiny::numericInput("num2", label ="Acceptable rate", value = 0.3, min = 0, max = 1, step = 0.05),

          shiny::numericInput("num3", label ="Alpha", value = 0.05, min = 0, max = 1, step = 0.05),

          shiny::numericInput("num4", label ="Power", value = 0.80, min = 0, max = 1, step = 0.05)
